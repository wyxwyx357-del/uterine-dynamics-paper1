...
def main():
    ...
    axes[0].barh(labels,strata.median_abs_relative_change_pct,color=["#246b99" if x=="median" else "#d9792b" for x in strata.statistic])
    axes[0].set_xlabel("Median absolute relative change (%)\nPatients with pending grade-3")
